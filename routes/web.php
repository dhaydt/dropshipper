...
Route::get('payment-callback', [XenditPaymentController::class, 'callback']);
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode']], function () {
    ...
    Route::group(['middleware' => ['customer']], function () {
        ...
        Route::get('checkout-shipping-method', 'WebController@shipping_method')->name('checkout-shipping-method')->middleware('customer');
    ...
    Route::group(['prefix' => 'xendit-payment', 'as' => 'xendit-payment.'], function () {
        ...
        Route::get('/success/{type}/{group}', 'XenditPaymentController@success')->name('xenditSuccess');
