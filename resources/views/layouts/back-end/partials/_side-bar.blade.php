                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--product management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('marketing_section'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/deal/unggulan')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/deal/berlimpah')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
