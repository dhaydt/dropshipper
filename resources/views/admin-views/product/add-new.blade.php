                            ...
                            @foreach(json_decode($language) as $lang)
                                <div class="{{$lang != $default_lang ? 'd-none':''}} lang_form"
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description[]" class="editor textarea" cols="30" id="desc"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label
                                            class="control-label">{{\App\CPU\translate('Dropship_price')}}</label>
                                        <input type="number" min="0" step="0.01"
                                               placeholder="{{\App\CPU\translate('Dropship price')}}"
                                               value="{{old('dropship_price')}}"
                                               name="dropship_price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row pt-4">
                                    <div class="col-md-5">
