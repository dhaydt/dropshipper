                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="product_code" placeholder="Produk SKU"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label">{{\App\CPU\translate('Dropship price')}}</label>
                                    <input type="number" min="0" step="0.01"
                                        placeholder="{{\App\CPU\translate('Dropship price') }}" name="dropship_price"
                                        class="form-control" value={{ \App\CPU\Convert::default($product->dropship) }}
                                    required>
                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <img style="width: 100%" height="auto"
                                                        ...
                                                        src="{{asset("
                                                        storage/product/meta")}}/{{$product['meta_image']}}"
                                                        alt="Meta image">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img style="width: 100%" height="auto"
                                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                            src="{{asset("
                                                            storage/product/thumbnail")}}/{{$product['thumbnail']}}"
                                                            alt="Product image">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img style="width: 100%" height="auto"
                                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                            src="{{asset("
                                                            storage/product/icon")}}/{{$product['icon']}}"
                                                            alt="Product image">
    ...
    function getRequest(route, id, type) {
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('{{url('/')}}/adminpanel/product/get-categories?parent_id=' + category + '&sub_category=' + sub_category, 'sub-category-select', 'select');
                getRequest('{{url('/')}}/adminpanel/product/get-categories?parent_id=' + sub_category + '&sub_category=' + sub_sub_category, 'sub-sub-category-select', 'select');
            }, 100)
