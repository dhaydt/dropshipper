...
@section('title', \App\CPU\translate('Diskon Berlimpah'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    {{ \App\CPU\translate('diskon_berlimpah_form')}}
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group">
                            @foreach(json_decode($language) as $lang)
                                <div class="row {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <input type="text" name="deal_type" value="berlimpah"  class="d-none">
                                    <div class="col-md-12">
                        ...
                        <table id="datatable"
                            ...
                            @foreach($flash_deal as $k=>$deal)
                                <tr>
                                    ...
                                    <td>{{$deal['end_date']}}</td> --}}
                                    <td>
                                        <a href="{{route('admin.deal.add-category',[$deal['id']])}}"
