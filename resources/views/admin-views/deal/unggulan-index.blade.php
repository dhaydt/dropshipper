...
@section('title', \App\CPU\translate('Produk Unggulan'))
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('produk_unggulan')}}</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    {{ \App\CPU\translate('produk_unggulan_form')}}
                </div>
                <div class="card-body">
                    <form action="{{route('admin.deal.unggulan')}}" method="post" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            @foreach(json_decode($language) as $lang)
                                <div class="row {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <input type="text" name="deal_type" value="unggulan"  class="d-none">
                                    <div class="col-md-12">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <center>
                                        <img style="width: auto;border: 1px solid; border-radius: 10px; width: 150px; height:200px;" id="viewer"
                        ...
                        <table id="datatable"
                            ...
                            @foreach($flash_deal as $k=>$deal)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.deal.update-unggulan',[$deal['id']])}}"
                                           class="btn btn-primary btn-sm">
